...
def predict_and_emb(model: MoleculeModel,
    ...
    for batch in tqdm(data_loader, disable=disable_progress_bar, leave=False):
        ...
        with torch.no_grad():
            ...
            batch_embds = model.final_node_embeddings(mol_batch, features_batch, atom_descriptors_batch)
